...
const Casual = () => (
  <div className="min-h-screen pt-28 pb-16 flex items-center justify-center">
    <div className="text-center space-y-6 max-w-md mx-auto px-4">
      ...
      <h1 className="text-3xl md:text-4xl font-bold">Casual Wear</h1>
      <p className="text-gray-400">This collection is coming soon. Stay tuned for our latest casual styles.</p>
      <Link
        to="/collections"
